...
# DM FILEPATH
dmFP <- "/Users/melissachen/Documents/Masters/Other_peoples_stuff/JordanData/bray_curtis_rarefaction_400_CAZy.txt"

# MF FILEPATH
mfFP <- "/Users/melissachen/Documents/Masters/Other_peoples_stuff/JordanData/cazy_sample.mapping.txt"
...
axis1 <- 1
axis2 <- 2
toPlot <- dm.pcoa$vectors[,c(axis1,axis2)] # Extracts columns axis1 and axis2 (1 and 2, set above)
